...
const DriverRegisterScreen: React.FC<DriverRegisterScreenProps> = ({ navigation }) => {
  ...
  const handleRegister = async () => {
    ...
    setTimeout(() => {
      ...
      Alert.alert(
        'Заявка отправлена!', 
        'Ваша заявка на регистрацию водителя отправлена на рассмотрение. Мы свяжемся с вами в течение 24 часов для подтверждения документов.', 
          ...
          <View style={styles.form}>
            ...
            >
              <Text style={styles.registerButtonText}>
                {isLoading ? 'Отправка заявки...' : 'Подать заявку'}
              </Text>
          ...
          <View style={[styles.modalContainer, isDark && styles.modalContainerDark]}>
            ...
            <ScrollView style={styles.modalContent} showsVerticalScrollIndicator={false}>
              <Text style={[styles.modalText, isDark && styles.modalTextDark]}>
                ...
                5. Водители проходят тщательную проверку и верификацию документов{'\n\n'}
            ...
            <TouchableOpacity
              style={[styles.modalButton, styles.driverModalButton]}
              onPress={() => setShowTermsModal(false)}
            >
